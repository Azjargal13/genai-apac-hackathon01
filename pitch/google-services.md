...
| **Cloud Build** | CI/CD from GitHub: build image on push, deploy to Run (see [cloud deploy guide](../doc/cloud-deploy.md)). |
...
- **Firebase** — Firestore is often provisioned via a Firebase project; [firebase setup](../doc/firebase.md) documents the link.
- **Testing OAuth** — Consent screen in **Testing** mode with explicit test users is appropriate for hackathon demos ([google tasks/calendar guide](../doc/google-tasks-calendar.md)).

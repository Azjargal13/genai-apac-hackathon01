...
Deploying to **Google Cloud Run** after you push is covered in [cloud-deploy.md](cloud-deploy.md).
...
After you connect **Cloud Build** to this repo ([cloud-deploy.md](cloud-deploy.md)), a push to the configured branch can **build the Docker image and deploy Cloud Run** automatically.
...
| Deploy | **Cloud Build → Cloud Run** — [cloud-deploy.md](cloud-deploy.md) |
